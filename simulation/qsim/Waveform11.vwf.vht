...
-- *****************************************************************************
-- Generated on "12/03/2019 16:39:11"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          extensorLUI
-- 
...
ENTITY extensorLUI_vhd_vec_tst IS
END extensorLUI_vhd_vec_tst;
ARCHITECTURE extensorLUI_arch OF extensorLUI_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
SIGNAL estendeSinal_IN : STD_LOGIC_VECTOR(7 DOWNTO 0);
SIGNAL estendeSinal_OUT : STD_LOGIC_VECTOR(15 DOWNTO 0);
COMPONENT extensorLUI
	PORT (
	estendeSinal_IN : IN STD_LOGIC_VECTOR(7 DOWNTO 0);
	estendeSinal_OUT : OUT STD_LOGIC_VECTOR(15 DOWNTO 0)
	);
END COMPONENT;
BEGIN
	i1 : extensorLUI
